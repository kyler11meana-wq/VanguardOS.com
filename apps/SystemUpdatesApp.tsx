            ...
            <div className="px-6 py-4 space-y-8">
                ...
                <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 text-v-text-light dark:text-v-text-dark p-2">
                        <li>
                            <span className="font-semibold">Battery Management:</span> New Battery section in Settings with charging controls.
                        </li>
                        <li>
                            <span className="font-semibold">Enhanced Power-Off Screen:</span> The power-off screen now displays charging status and low battery warnings.
                        </li>
                        <li>
                            <span className="font-semibold">UI Refinements:</span> Removed the Permissions section from Settings for a cleaner interface.
                        </li>
                        <li>
